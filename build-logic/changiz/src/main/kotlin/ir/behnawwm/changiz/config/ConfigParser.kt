...
object ConfigParser {
    ...
    fun parse(projectDir: File): ChangizConfig {
        ...
        return ChangizConfig(
            ...
            publicRequired = changelog?.get("public")?.get("required")?.toString()?.toBooleanStrictOrNull() ?: true,
            internalRequired = changelog?.get("internal")?.get("required")?.toString()?.toBooleanStrictOrNull() ?: false,
